...
print("Second Hero:", full_list[0][1])
print("Third villian:", full_list[1][2])

marvel_villains.append("Deadpool")
marvel_heroes.append("Deadpool")

print("Updated Villians:", marvel_villains)
print("UPdated Heroes:", marvel_heroes) 
